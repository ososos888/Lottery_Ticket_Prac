...
# %%
FileName = 'test_result/' + args.testname + '_result.txt'
temp = sys.stdout
...
title = args.testname + "_" + Tracker_type
...
for test_iter in range(1, args.test_iters+1):
    ...
    trained_weights[test_iter] = []
    for name, p in model.named_parameters():
        if 'weight' in name:
            a = copy.deepcopy(p)
            trained_weights[test_iter].append(a)
...
dic_FileName2 = "test_result/" + args.testname + "_trained_weights"
