...
class parameters:
    def __init__(self):
        ...
        self.remaining_weight_c = 'empty'
        self.remaining_weight_f = 'empty'
        self.remaining_weight_o = 'empty'
    ...
    def type(self, x):
        if x == 'LeNet300':
            ...
            self.iteration = 0
            #self.__remaining_weight = 1
            self.remaining_weight_f = 1
            self.remaining_weight_o = 1
