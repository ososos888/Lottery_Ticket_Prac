...
if __name__=="__main__":
    ...
    parser.add_argument("--testname", default = "TESTMODEL3", type=str, help="Check your test file name")
...
for test_iter in range(1, args.test_iters+1):
    ...
    for prune_iter in range(args.prune_iters):
        ...
        for epoch in range(args.epochs):
            ...
            save_result()
        test_result2[test_iter][remaining_weight] = test_result2[test_iter].pop(prune_iter)    
